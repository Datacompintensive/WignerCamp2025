...
\begin{frame}{What is a Vector?}
  \begin{itemize}
    \item \textbf{Mathematician's view:} A set that satisfies the 8 axiom.
    ...
    \item \textbf{Notation:}
    \begin{itemize}
      \item Boldface: $\mathbf{v}$ (common in CS)
    ...
    \begin{example}[Vectors]
        ...
        \vec{c} = \begin{bmatrix} -3 \\ 2 \\ 5 \end{bmatrix}, \quad
...
\begin{frame}{Matrix-Matrix Multiplication}
  ...
  \Rightarrow AB = \begin{bmatrix} 4 & 4 \\ 10 & 8 \end{bmatrix}
  \end{equation}
  \end{example}
  \begin{example}
  \begin{equation}
  A = \begin{bmatrix} 1 & 2 & 3 \\ 4 & 5 & 6 \end{bmatrix}, B = \begin{bmatrix} 1 & 0 \\ 0 & 1 \\ 1 & 1 \end{bmatrix}
  \Rightarrow AB = \begin{bmatrix} 4 & 5 \\ 10 & 11 \end{bmatrix}
  \end{equation}
  \end{example}
\end{frame}
...
\begin{frame}{Extra: Eigenvalue Problem: More Detail}
  \begin{itemize}
    \item Step 1: Start with $A\vec{v} = \lambda \vec{v}$.
    \item Step 2: Rewrite as $(A - \lambda I)\vec{v} = 0$.
    \item Step 3: Solve $\det(A - \lambda I) = 0$ (this gives a polynomial).
    \item Step 4: Find the roots (eigenvalues), then solve the nullspace for each to get eigenvectors.
  \end{itemize}
  \begin{example}
    \begin{equation}
    A = \begin{bmatrix} 2 & 1 \\ 1 & 2 \end{bmatrix} \Rightarrow
    \det\left(\begin{bmatrix} 2 - \lambda & 1 \\ 1 & 2 - \lambda \end{bmatrix}\right) = (2 - \lambda)^2 - 1 = \lambda^2 - 4\lambda + 3.
    \end{equation}
    \begin{itemize}
        \item Roots: $\lambda = 1, 3$.
        \item For $\lambda = 3$: $(A - 3I)\vec{v} = 0 \Rightarrow \vec{v}_1 = \begin{bmatrix} 1 \\ 1 \end{bmatrix}.$
        \item For $\lambda = 1$: $(A - I)\vec{v} = 0 \Rightarrow \vec{v}_2 = \begin{bmatrix} 1 \\ -1 \end{bmatrix}.$
    \end{itemize}
  \end{example}
\end{frame}
